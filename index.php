...
<?php
    ...
    $result = mysql_query("select * from temperatura order by idtemperatura desc");
    ...
    while( $row = mysql_fetch_array($result) )
    {
        ...
        echo '   <td'.$css_class.'>'.$row["fecha_hora"].'</td>';
        echo '   <td'.$css_class.'>'.$row["dispersion"].'</td>';
        echo '   <td'.$css_class.'>'.$row["voltaje"].'</td>';
