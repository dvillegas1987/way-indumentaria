...
(function(f){
	...
	p(x.lang,{printChart:"Imprimir Grafica",downloadPNG:"Descargar imagen PNG",downloadJPEG:"Descargar imagen JPEG",downloadPDF:"Descargar document PDF",downloadSVG:"Descargar imagen de vector SVG",contextButtonTitle:"Menu de la grafica"});
	x.navigation={
		menuStyle:{
		...
		buttonOptions:{
			symbolFill:"#E0E0E0",symbolSize:14,symbolStroke:"#666",symbolStrokeWidth:3,symbolX:12.5,symbolY:10.5,align:"right",buttonSpacing:3,height:22,theme:{fill:"white",stroke:"none"},verticalAlign:"top",width:24
		}
	};
	x.exporting={
	...
	f.post=function(c,a){var d,b;b=k("form",{method:"post",
