...
return [
    ...
    [
        ...
        'filterType'=>GridView::FILTER_SELECT2,
        'filter' => [0 => 'Mujer',1 => 'Hombre'] /*ArrayHelper::map(Categoria::find()->orderBy(['codigo' => SORT_ASC])->all(),'codigo', 'descripcion')*/,
    ...
    [
        ...
        'filterType'=>GridView::FILTER_SELECT2,
        'filter' => [0 => 'Buenos Aires',1 => 'Chile', 2 => 'Oulet'] /*ArrayHelper::map(Categoria::find()->orderBy(['codigo' => SORT_ASC])->all(),'codigo', 'descripcion')*/,
                ...
                'update' => function ($url, $model) {
                    ...
                    $url = Url::to(['update', 'id' => $model->id ]);   
                         ...
                         return Html::a('<button class="btn btn-default btn-xs"><i class="glyphicon glyphicon-pencil"></i></button>', $url, [
                                'title' => Yii::t('app', 'Actualizar persona'),
                        'role'=>'modal-remote']);
